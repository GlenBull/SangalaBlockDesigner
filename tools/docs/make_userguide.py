...
# ---------------------------------------------------------------- 11
d.heading("11. Seeing the Design in Three Dimensions")
...
d.body("One part of the installation matters to the snapshots described in Section 13. The renderer that "
